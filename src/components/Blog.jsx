  ...
  return (
    <div style={blogStyle}>
      <div className="blog">
        ...
        <button id="btn-view" className="detailsButton" onClick={handleVisibility}>
      ...
      <div className="blogDetails" style={showDetails ? showWhenShowDetails : hideWhenShowDetails}>
        ...
        <div>
          likes {blog.likes}{" "}
          <button id="btn-like" onClick={() => handleLike(blog.id)}>like</button>
        </div>
        <div>{blog.user.name}</div>
        {user.name === blog.user.name ? (
          <button id="btn-remove" onClick={() => handleRemoveBlog(blog.id)}>remove</button>
        ) : (
          ""
        )}
      </div>
